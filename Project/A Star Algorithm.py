...
def pathFind(n, m, dirs, xA, yA, xB, yB, obstacle_string):
    ...
    for i in range(len(obstacle_list)):                 # Access individual elements within the obstacle list
        ...
        print item
        for j in item:
            print j.strip()                             # Strip away white space from front and back
...
def Main():
    ...
    string_list = "12, 34, 54; 23, 43, 2"
    route = pathFind(n, m, dirs, xA, yA, xB, yB, string_list)
